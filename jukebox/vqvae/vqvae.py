...
class VQVAE(nn.Module):
    ...
    def decode(self, zs, start_level=0, end_level=None, bs_chunks=None, length_chunks=None):
        ...
        for i in range(bs_chunks):
            ...
            for i2 in range(length_chunks):
                zs_i = [z_chunk[i2].to(t.device("mps")) for z_chunk in zi_chunks]
    ...
    def encode(self, x, start_level=0, end_level=None, bs_chunks=None, length_chunks=None):
        ...
        for x_i in x_chunks:
            ...
            for x_i2 in xi_chunks:
                zs_i2 = self._encode(x_i2.to(t.device("mps")), start_level=start_level, end_level=end_level)
    ...
    def sample(self, n_samples):
        zs = [t.randint(0, self.l_bins, size=(n_samples, *z_shape), device=t.device("mps")) for z_shape in self.z_shapes]
