...
if False:
    ...
    labels[:2] = [upsamplers[0].labeller.get_batch_labels(metas, xm.xla_device()) for i in range(2)]
    labels[2] = labels[1]
    ...
    labels[:2] = [prior.labeller.get_batch_labels(metas, xm.xla_device()) for prior in upsamplers]
    labels[2] = labels[1]
